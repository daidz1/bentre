...
import vn.com.ngn.site.views.doclist.layout.TaskCreateFromDocLayout;
import vn.com.ngn.site.views.doclist.layout.TaskOrgCreateFromDocLayout;
...
public class DocDetailDialog extends DialogTemplate{
	...
	private TaskCreateFromDocLayout taskCreateLayout;
	//Dzung code
	private TaskOrgCreateFromDocLayout taskCreateOrgLayout;
	//end Dzung code
	...
	public void configComponent() {
		...
		taskCreateLayout.getBtnTrigger().addClickListener(e->{
			System.out.println("=====TaskCreateFromDocLayout: btnTrigger click =====");
			vTaskList.setVisible(true);
			taskCreateLayout.setVisible(false);
			taskCreateOrgLayout.setVisible(false);
			try {
...
//		btnCreateTask.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
	...
	private void buildRightLayout() {
		...
		taskCreateLayout = new TaskCreateFromDocLayout(jsonDoc);
		taskCreateOrgLayout =new TaskOrgCreateFromDocLayout(jsonDoc);
