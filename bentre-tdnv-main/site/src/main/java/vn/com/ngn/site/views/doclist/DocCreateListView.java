...
@Route(value = "doccreatelist", layout = MainView.class)
@PageTitle("Danh sách văn bản")
public class DocCreateListView extends VerticalLayout implements LayoutInterface,BeforeEnterObserver,RouterLayout{
	...
	private Button cmdAdd = new Button("Thêm văn bản",new Icon(VaadinIcon.PLUS));

	public DocCreateListView() {

	}

	@Override
	public void buildLayout() {
		this.cmdAdd.addThemeVariants(ButtonVariant.LUMO_TERTIARY);
...
//			model.setDocNumber(110);
//			model.setDocSummary("test doc");
//			model.setDocCategory("FrOfficialOut");
//			model.setDocSecurity("Hỏa tốc");
