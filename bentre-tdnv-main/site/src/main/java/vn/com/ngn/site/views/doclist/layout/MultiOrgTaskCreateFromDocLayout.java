...
import vn.com.ngn.site.views.taskcreate.TaskBlockForMultiCreateOrgLayout;
import vn.com.ngn.site.views.taskcreate.TaskInfoLayout;
import vn.com.ngn.site.views.tasklist.TaskListView;

public class MultiOrgTaskCreateFromDocLayout extends VerticalLayout implements LayoutInterface{
	...
	public MultiOrgTaskCreateFromDocLayout(JsonObject jsonDoc) {
				...
				if(isValid) {
					...
					for(TaskBlockForMultiCreateOrgLayout modelTaskLayout : listTaskLayout) {
						...
						try {
							...
							JsonObject jsonResponse = TaskServiceUtil.createOrgTask(null,docId,modelTaskInfo,modelUserOwner,null, modelData.getModelOrgAssignee(), modelData.getListOrgSupport());
