...
public class TaskOrgCreateFromDocLayout extends VerticalLayout implements LayoutInterface{
	private Button btnChangeState = new Button("Giao nhiều nhiệm vụ",VaadinIcon.REFRESH.create());
	private TaskOrgCreateFromDocComponent layoutCreateTask ;
	private MultiOrgTaskCreateFromDocLayout layoutMultiCreateTask ;
	private JsonObject jsonDoc;
	
	private Button btnTrigger = new Button();
	private Button btnCancel = new Button();
	
    public TaskOrgCreateFromDocLayout(JsonObject jsonDoc) {
    	this.jsonDoc = jsonDoc;
    	layoutMultiCreateTask = new MultiOrgTaskCreateFromDocLayout(jsonDoc);
    	layoutCreateTask = new TaskOrgCreateFromDocComponent(jsonDoc);
    	buildLayout();
    	configComponent();
    }
	...
	public void configComponent() {
		...
		layoutMultiCreateTask.getBtnTrigger().addClickListener(e->{
			System.out.println("=====MultiOrgTaskCreateFromDocComponent: btnTrigger click =====");
			btnTrigger.click();
		});
