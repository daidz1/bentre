...
@Route(value = "reportorg", layout = MainView.class)
@PageTitle("Báo cáo thống kê theo đơn vị")
public class ReportOrgView extends VerticalLayout implements LayoutInterface {
	private TaskFilterModule taskFilter = new TaskFilterModule();
	private VerticalLayout vDisplay = new VerticalLayout();
	
	public ReportOrgView() {
		buildLayout();
		configComponent();
	}
