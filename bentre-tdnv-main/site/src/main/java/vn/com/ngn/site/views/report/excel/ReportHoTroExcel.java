...
public class ReportHoTroExcel extends ExcelExport{
	private String template = templatePath+"theodoi.xlsx";
	...
	{	
		...
		return getStreamResource("Nhiem vu ho tro-"+new Date().getTime()+".xlsx", byteOutputStream.toByteArray());
	}
	
	public void createSheet() throws XPathExpressionException {
		XSSFSheet sheetSum = workbook.getSheet("theodoi");
