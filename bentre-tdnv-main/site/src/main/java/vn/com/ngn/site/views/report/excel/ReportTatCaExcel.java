...
public class ReportTatCaExcel extends ExcelExport{
	private String template = templatePath+"tatca.xlsx";
	...
	{	
		...
		return getStreamResource("Tat ca nhiem vu-"+new Date().getTime()+".xlsx", byteOutputStream.toByteArray());
	}
