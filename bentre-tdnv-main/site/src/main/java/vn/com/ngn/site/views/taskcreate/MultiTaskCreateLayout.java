...
public class MultiTaskCreateLayout extends VerticalLayout implements LayoutInterface{
	private int count = 0;
				...
				if(isValid) {
					...
					for(TaskBlockForMultiCreateLayout modelTaskLayout : listTaskLayout) {
						...
						try {
							...
							JsonObject jsonResponse = TaskServiceUtil.createTask(null,null,modelTaskInfo,modelUserOwner,null, modelData.getModelUserAssignee(), modelData.getListUserSupport());
