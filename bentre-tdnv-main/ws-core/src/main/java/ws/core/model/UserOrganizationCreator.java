...
@Setter
@ToString
public class UserOrganizationCreator {
	...
	public UserOrganizationCreator() {

	}
	
	public UserOrganizationCreator(@NotEmpty(message = "userId không được trống") String userId,
	...
	public boolean compareTo(UserOrganizationCreator userTaskOther) {
